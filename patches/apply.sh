...
git apply -v ../../device/xiaomi/hermes/patches/framework_av/0004-frameworks_av_videorecording_fix.patch
cd ../..
cd frameworks/base
git reset --hard ; git clean -qfdx
...
git apply -v ../../device/xiaomi/hermes/patches/framework_base/0004-Update-for-mtk.patch
cd ../..
